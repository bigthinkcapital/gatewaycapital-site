...
export const metadata: Metadata = {
  ...
  description:
    'Gateway Capital matches businesses to SBA loans, term loans, lines of credit, equipment financing, invoice financing, and merchant cash advances. One application, multiple lenders, best terms. Apply in 2 minutes.',
  keywords: [
...
const SERVICES = [
  ...
  },
  {
    ...
    desc: 'Access capital based on your future credit card and debit card sales. Repay through a percentage of daily revenue — no fixed monthly payment. Built for high-volume businesses needing fast capital with minimal documentation.',
    amount: '$5K – $750K',
